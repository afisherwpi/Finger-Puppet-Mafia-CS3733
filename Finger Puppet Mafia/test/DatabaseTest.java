...
public class DatabaseTest {
	...
	public void setUp(){
		...
		database.addCategory("java","description1", true);
		database.addCategory("oracle","description2", true);
		database.addCategory("db4o", "description3",true);
		database.addCategory("eclipse", "description4",true);
	...
	public void testAddCategory(){
		...
		database.addCategory("tester_cat","new_desc", true);
